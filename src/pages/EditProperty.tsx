        ...
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription className="text-center pt-2">
              This feature is only available for property owners. You need to have an owner account to access this page.
            </DialogDescription>
          </DialogHeader>
...
const EditProperty = () => {
  ...
  const { isOwner, isLoading: authLoading } = useOwnerCheck('/signup?role=owner&next=/list-property');
  ...
  const fetchProperty = async () => {
    try {
      ...
      if (data.success && data.property) {
        ...
        setUploadedPhotoUrls(formattedPhotos);
      }
    } catch (error: any) {
    ...
    <Layout>
      <div className="min-h-screen bg-background py-8">
        <div className="container-custom max-w-3xl">
          {/* Header */}
          <div className="mb-8">
            <Link to="/owner-listings" className="inline-flex items-center text-sm text-muted-foreground hover:text-primary mb-4">
          ...
          {/* Form - Reuse ListProperty form structure */}
              ...
              {currentStep === 5 && (
                <div className="space-y-6 animate-fade-in">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Add or update photos of your property. You can upload one or multiple photos.
                  </p>
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground">
                      PNG, JPG up to 5MB each. Upload one or multiple photos.
                    </p>
                    <input
                      ref={fileInputRef}
                      type="file"
